    					...
    					<ul class="list-unstyled media-block">
    						<li class="mar-btm">
    							<div class="media-left">
    								<img src="<c:url value='resources/images/1.png" class="img-circle img-sm" alt=""'/>"/>
    							</div>
    						...
    						<li class="mar-btm">
    							<div class="media-right">
    								<img src="<c:url value='resources/images/1.png" class="img-circle img-sm" alt="Profile Picture"'/>"/>
    							</div>
    							<div class="media-body pad-hor speech-right">
    								<div class="speech">
    									<a href="#" class="media-heading">----</a>
